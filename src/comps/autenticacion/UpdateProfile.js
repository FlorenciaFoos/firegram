...
export default function UpdateProfile() {
    ...
    return (
        <>
            <Nav />
            <div className='grid h-screen place-items-center bg-pink-200'>
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div id="email">
                            ...
                            <input className=' w-full bg-white text-black border border-gray-200 rounded py-3 px-4 mb-3 focus:bg-white'
                                type="email"
                                ref={emailRef}
                                required
